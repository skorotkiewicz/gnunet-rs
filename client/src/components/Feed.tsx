...
import { Heart, Repeat2, UserPlus, Globe, Users, Lock, UserCheck } from 'lucide-react';
import { useSocial } from '../hooks';
import type { PostVisibility } from '../types';

export function Feed() {
  const { posts, createPost, connected, likePost, requestFriend, peerId, friends, showProfile } = useSocial();
