import { ArrowUpRight, Check, Copy, Info, Mail, Plus } from "lucide-react";
			...
			<section className="rooms-section">
				...
				{showJoinRoom && (
					<form className="inline-form" onSubmit={handleJoinRoom}>
						...
						<button type="button" onClick={() => setShowJoinRoom(false)}>
							×
						</button>
					</form>
				)}
					...
					<div className="modal" onClick={(e) => e.stopPropagation()}>
						...
						<form onSubmit={handleSendMessage}>
							...
							<div className="modal-actions">
								...
								<button type="button" onClick={() => setShowMessage(null)}>
									Cancel
								</button>
							</div>
						</form>
					...
					return (
						...
						>
							<div className="modal" onClick={(e) => e.stopPropagation()}>
								...
								<div className="modal-actions">
									<button type="button" onClick={() => setShowRoomInfo(null)}>
										Close
									</button>
								</div>
							</div>
